      ...
      <Sheet open={isOpen} onOpenChange={toggle}>
        ...
        >
          ...
          <div className="flex flex-1 flex-col overflow-hidden px-6 pb-6">
            <div className="mb-4 flex gap-3 border-slate-200 border-b pb-4 dark:border-slate-700">
              <Button
                variant="outline"
                className="flex-1 cursor-pointer gap-2 rounded-(--radius)"
                onClick={() => {
            ...
            >
              <TabsList className="mb-3 grid w-full grid-cols-3 rounded-lg">
                <TabsTrigger
                  value="colors"
